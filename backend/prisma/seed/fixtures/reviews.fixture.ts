import {
  ...
  CuratedServiceKey,
  CuratedEventKey,
  type VenueReviewSeed,
  type ServiceReviewSeed,
  type EventReviewSeed,
} from '../types';

export const VENUE_REVIEWS: VenueReviewSeed[] = [
  {
    userKey: CuratedUserKey.PARTICIPANT_1,
  ...
  {
    userKey: CuratedUserKey.PARTICIPANT_2,
    venueKey: CuratedVenueKey.TASHKENT_CITY_HALL,
    rating: 4,
    comment:
...
export const SERVICE_REVIEWS: ServiceReviewSeed[] = [
  {
    userKey: CuratedUserKey.PARTICIPANT_1,
    serviceKey: CuratedServiceKey.PREMIUM_CATERING,
    rating: 5,
    comment: 'Katering eng yuqori darajada! Taomlar juda mazali edi.',
  },
  {
    userKey: CuratedUserKey.PARTICIPANT_2,
    serviceKey: CuratedServiceKey.ELITE_SOUND,
    rating: 4,
    comment: 'Ovoz jihozlari ajoyib, texnik doimo yonimizda edi.',
  },
  {
    userKey: CuratedUserKey.PARTICIPANT_3,
    serviceKey: CuratedServiceKey.CAPTURE_PHOTO,
    rating: 5,
    comment:
  ...
  {
    userKey: CuratedUserKey.PARTICIPANT_4,
    serviceKey: CuratedServiceKey.ELEGANT_DECOR,
    rating: 5,
    comment: "Dekor zamonaviy va nafis edi, konsepsiyamizga to'liq mos keldi.",
  },
  {
    userKey: CuratedUserKey.PARTICIPANT_5,
    serviceKey: CuratedServiceKey.SECURE_GUARD,
    rating: 3,
    comment:
  ...
  {
    userKey: CuratedUserKey.PARTICIPANT_1,
    serviceKey: CuratedServiceKey.SAMARKAND_CATERING,
    rating: 5,
    comment:
...
export const EVENT_REVIEWS: EventReviewSeed[] = [
  {
    userKey: CuratedUserKey.PARTICIPANT_1,
    eventKey: CuratedEventKey.MARKETING_FORUM,
    rating: 5,
  ...
  {
    userKey: CuratedUserKey.PARTICIPANT_3,
    eventKey: CuratedEventKey.TECH_MEETUP,
    rating: 5,
    comment:
  ...
  {
    userKey: CuratedUserKey.PARTICIPANT_4,
    eventKey: CuratedEventKey.JAZZ_FESTIVAL,
    rating: 5,
    comment: 'Unutilmas festival! Uch kunlik jaz, food-zona va art.',
  },
  {
    userKey: CuratedUserKey.PARTICIPANT_5,
    eventKey: CuratedEventKey.UX_WORKSHOP,
    rating: 4,
    comment: "Vorkshop amaliy ko'nikmalar berdi. Keyslar dolzarb.",
  },
  {
    userKey: CuratedUserKey.PARTICIPANT_3,
    eventKey: CuratedEventKey.SILK_ROAD_EXHIBITION,
    rating: 5,
