    ...
    >
      ...
      <div className="relative overflow-hidden h-52 shrink-0">
        ...
        <div
          ...
          style={{ background: 'linear-gradient(to top, rgba(8,15,25,0.92) 0%, rgba(8,15,25,0.45) 45%, transparent 75%)' }}
        />
        ...
        <div
          ...
          style={{ color: dot, borderColor: `${dot}33`, background: 'rgba(8,15,25,0.55)' }}
        >
