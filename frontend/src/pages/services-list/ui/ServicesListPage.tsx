  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex gap-2 flex-wrap">
        ...
        {CATEGORIES.map((c) => (
          <button
            ...
            className={`px-4 py-1.5 rounded-full text-sm font-medium transition-colors cursor-pointer ${
              category === c.value ? 'bg-indigo-600 text-white' : 'bg-white border border-gray-200 text-gray-600 hover:border-indigo-300'
            }`}
          >
            {c.label}
          </button>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-16 text-gray-400">Услуг не найдено</div>
      ) : (
